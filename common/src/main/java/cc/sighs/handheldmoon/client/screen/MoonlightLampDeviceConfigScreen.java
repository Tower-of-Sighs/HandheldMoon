...
public class MoonlightLampDeviceConfigScreen extends Screen {
    ...
    private final DeviceConfigTargets.LampTarget target;
    ...
    public MoonlightLampDeviceConfigScreen(DeviceConfigTargets.LampTarget target) {
        this(target, null);
    }

    public MoonlightLampDeviceConfigScreen(DeviceConfigTargets.LampTarget target, Screen parent) {
