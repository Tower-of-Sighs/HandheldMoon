...
public class Config {
    ...
    public static final ForgeConfigSpec.ConfigValue<Double> LIGHT_RANGE;
    public static final ForgeConfigSpec.ConfigValue<Double> LIGHT_ANGLE;
    public static final ForgeConfigSpec.ConfigValue<List<? extends String>> LIGHT_COLORS_ARGB;
    ...
    public static final ForgeConfigSpec.ConfigValue<Boolean> CONE_RAYCAST;
    public static final ForgeConfigSpec.ConfigValue<Double> REAL_LIGHT_LUMINANCE;
    public static final ForgeConfigSpec.ConfigValue<List<? extends String>> LAYER_SIZE_SCALES;
    public static final ForgeConfigSpec.ConfigValue<List<? extends String>> LAYER_CENTER_ALPHAS;
    public static final ForgeConfigSpec.ConfigValue<List<? extends String>> LAYER_EDGE_ALPHAS;
    public static final ForgeConfigSpec.ConfigValue<List<? extends String>> LAYER_COLORS_ARGB;
    public static final ForgeConfigSpec.ConfigValue<Double> COLOR_NOISE_AMPLITUDE;
    public static final ForgeConfigSpec.ConfigValue<Boolean> FOG_ENABLED;
    public static final ForgeConfigSpec.ConfigValue<Double> FOG_SIZE_SCALE;
    public static final ForgeConfigSpec.ConfigValue<Double> FOG_CENTER_ALPHA;
    public static final ForgeConfigSpec.ConfigValue<Double> FOG_EDGE_ALPHA;
    public static final ForgeConfigSpec.ConfigValue<String> FOG_COLOR_ARGB;
