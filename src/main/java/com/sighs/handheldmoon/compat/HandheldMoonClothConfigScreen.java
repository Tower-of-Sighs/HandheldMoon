...
public class HandheldMoonClothConfigScreen {
    ...
    public static ConfigBuilder getConfigBuilder() {
        ...
        clientSettings.addEntry(entry.startBooleanToggle(
                ...
                .setTooltip(Component.translatable("config.handheldMoon.client_settings.enable_player_ray.tooltip", KeyBindings.FLASHLIGHT_SWITCH.getKey().getDisplayName()))
        ...
        clientSettings.addEntry(entry.startBooleanToggle(
                ...
                .setDefaultValue(true)
                .setTooltip(Component.translatable("config.handheldMoon.client_settings.enable_real_light.tooltip", KeyBindings.FLASHLIGHT_SWITCH.getKey().getDisplayName()))
        ...
        clientSettings.addEntry(entry.startDoubleField(
                ...
                .setMin(0.0)
                .setMax(1.0)
                .setTooltip(Component.translatable("config.handheldMoon.client_settings.light_intensity.tooltip", KeyBindings.FLASHLIGHT_SWITCH.getKey().getDisplayName()))
